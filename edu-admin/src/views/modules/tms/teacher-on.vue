  ...
  <div class="mod-config">
    ...
    >
      ...
      circle></el-button
        >
        <el-button
          v-if="isAuth('tms:teacher:delete')"
          type="danger"
          @click="deleteHandle()"
...
export default {
  ...
  methods: {
    ...
    changeIsActived(data) {
      ...
      this.$http({
        url: this.$http.adornUrl("/tms/teacher/update"),
        method: "post",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/tms/teacher/list/0"),
        method: "get",
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/tms/teacher/delete"),
          method: "post",
