<template>
  <el-row :gutter="20">
    <el-col :span="4">
      <cms-category-tree
        @category-tree-click="categoryTreeClick"
      ></cms-category-tree>
    </el-col>
      ...
      <div class="mod-config">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button
              v-if="isAuth('cms:content:delete')"
              type="danger"
              @click="deleteHandle()"
            ...
            <el-dropdown @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="a" icon="el-icon-document">
                  Start a new doc</el-dropdown-item
                >
                <el-dropdown-item command="b" icon="el-icon-upload2">
                  Upload files</el-dropdown-item
                >
                <el-dropdown-item command="c" icon="el-icon-mobile">
                  Dropbox</el-dropdown-item
                >
                <el-dropdown-item command="d" icon="el-icon-goods">
                  OneDirve</el-dropdown-item
                >
              </el-dropdown-menu>
            </el-dropdown>
          </el-form-item>
