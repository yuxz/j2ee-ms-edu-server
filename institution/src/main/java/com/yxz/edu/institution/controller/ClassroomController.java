...
public class ClassroomController {
    ...
    //@RequiresPermissions("ims:classroom:list")
    public R listByCampusId(@RequestParam Map<String, Object> params, @PathVariable("campusId") Long campusId){
        PageUtils page = classroomService.queryClassRoomByCampusId(params, campusId);
